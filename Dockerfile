...
ADD https://api.github.com/repos/markstanden/if-interested--kotlin/git/refs/heads/main version.json
RUN git clone -b main https://github.com/markstanden/if-interested--kotlin.git /app
...
WORKDIR /app
ENTRYPOINT ["./build/scriptsShadow/if-interested"]
